...
SHARD=-80 UID_BASE=200 TABLETS_UIDS=0 HOSTN=192.155.80.4 $script_root/vttablet-up.sh "$@"

# Shard 80- contains all entries whose keyspace ID has a first byte >= 0x80.
SHARD=80- UID_BASE=300 TABLETS_UIDS=0 HOSTN=173.230.153.12 $script_root/vttablet-up.sh "$@"
