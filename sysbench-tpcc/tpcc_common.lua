...
--      con:query("DROP TABLE IF EXISTS warehouse" .. i )
      ...
      con:query("TRUNCATE TABLE history" .. i )
      con:query("TRUNCATE TABLE new_orders" .. i )
      con:query("TRUNCATE TABLE order_line" .. i )
      con:query("TRUNCATE TABLE orders" .. i )
      con:query("TRUNCATE TABLE customer" .. i )
      con:query("TRUNCATE TABLE district" .. i )
      con:query("TRUNCATE TABLE stock" .. i )
      con:query("TRUNCATE TABLE item" .. i )
      con:query("TRUNCATE TABLE warehouse" .. i )
   end
end
